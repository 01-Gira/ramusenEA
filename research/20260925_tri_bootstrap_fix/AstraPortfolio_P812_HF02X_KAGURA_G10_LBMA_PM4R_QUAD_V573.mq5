...
void LB_EvaluateEvent(const MqlTick &q,datetime event_start)
{
 ...
 string c="LBMA-PM4R";ResetLastError();
 bool ok=(side>0?LB_trade.Buy(LB_InpFixedLot,_Symbol,0,sl,0,c):LB_trade.Sell(LB_InpFixedLot,_Symbol,0,sl,0,c));
...
void OnDeinit(const int reason)
  {
   ...
   if(g_pf_summary!=INVALID_HANDLE)
     {
      FileWrite(g_pf_summary,"build","P812_HF02X_KAGURA_G10_LBMA_PM4R_QUAD_V572_20260926");
